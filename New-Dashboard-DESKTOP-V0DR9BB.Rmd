...
ggplot(df_long, aes(x = Name, y = value, fill = variable)) +
  ...
  labs(x = "Languages", y = "Translation") +
  scale_fill_manual(values = c("Translated" = "green", "Fuzzy" = "blue", "Untranslated" = "red")) +theme(axis.text.x = element_text(angle = 90,size=18),legend.text = element_text(size = 14),axis.title.x = element_text(angle = 0,size=22),axis.text.y = element_text(angle = 0,size=18),axis.title.y = element_text(angle = 90,size=22))
