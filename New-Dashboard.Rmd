...
ggplot(df_long, aes(x = Name, y = value, fill = variable)) +
  ...
  scale_fill_manual(values = c("Translated" = "blue", "Fuzzy" = "green", "Untranslated" = "red")) +theme(axis.text.x = element_text(angle = 90,size=18),legend.text = element_text(size = 14))
